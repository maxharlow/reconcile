function initialise(parameters, requestor, die) {
    ...
    const request = requestor(2, e => {
        ...
        if (e.response.status === 404) return `Could not find beneficial owners for company ${company}` // either company doesn't exist or no beneficial owners registered
    ...
    function locate(entry) {
        ...
        return {
            url: `https://api.companieshouse.gov.uk/company/${companyNumber.padStart(8, '0').toUpperCase()}/persons-with-significant-control`,
            auth: {
