function initialise(parameters, requestor, alert) {
    ...
    function parse(response) {
        ...
        return {
            ...
            companyForeignCountry: company.foreign_company_details?.originating_registry?.country || null,
            companyForeignNumber: company.foreign_company_details?.registration_number || null,
...
const details = {
    ...
    columns: [
        ...
        { name: 'companyForeignCountry' },
        { name: 'companyForeignNumber' },
