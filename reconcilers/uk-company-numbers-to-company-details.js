function initialise(parameters, requestor, alert) {
    ...
    function parse(response) {
        ...
        return {
            ...
            companyForeignCountry: company.foreign_company_details?.originating_registry?.country,
            companyForeignNumber: company.foreign_company_details?.registration_number,
