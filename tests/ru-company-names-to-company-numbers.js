...
Ava('standard', async test => {
    ...
    const reconcillation = await Reconcile('ru-company-names-to-company-numbers', filename, {
    ...
    const resultsExpected = await FSExtra.readJson('./tests/expectations/ru-company-names-to-company-numbers.json')
